...
test_loader = DataLoader(test_dataset, batch_size=192, num_workers=8)
print("Test loader created.")
print("Creating train loader...")
train_loader = DataLoader(train_dataset, batch_size=192, num_workers=8)
print("Train loader created.")

class Net(torch.nn.Module):
    def __init__(self):
        super().__init__()
        self.conv1 = GATConv(20, 32, heads=4, dropout=0.2)  
