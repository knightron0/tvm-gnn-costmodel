...
def main(rank, world_size):
    ...
    val_loader = DataLoader(val_dataset, batch_size=2, num_workers=3, sampler=val_sampler)
    print("Test loader created.")

    print("Creating train loader...")
    train_sampler = DistributedSampler(train_dataset, num_replicas=world_size, rank=rank)
    train_loader = DataLoader(train_dataset, batch_size=2, num_workers=3, sampler=train_sampler)
