...
def main():    
    ...
    val_loader = DataLoader(val_dataset, batch_size=64, num_workers=8, persistent_workers=True)
    ...
    for epoch in range(1, 201):
        ...
        checkpoint_path = os.path.join(save_dir, f'model_new_{run_name}_{epoch}.pt')
